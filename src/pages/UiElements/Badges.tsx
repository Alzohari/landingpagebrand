...
const tabs = [
  {
    label: " اضافة الاسئلة الشائعة",
    title: "شرح رفع صورة الاسئلة الشائعة ",
    content: <ResponsiveImage srcimage="../../public/images/brand/السؤال تعليم.jpg" />,
  },
  {
    label: "  الاسئلة الشائعة| طريقة الضهور في الابتوب",
    title: "استعراض البراند على شاشة لابتوب",
    content: <ResponsiveImage srcimage="../../public/images/brand/الاسئلة لابتوب.png" />,
  },
  {
     label: "  الاسئلة الشائعة  | طريقة الضهور في الجوال",
    title: "استعراض البراند على شاشة الجوال",
    content: <ResponsiveImage srcimage="../../public/images/brand/الاسئلة جوال.png" />,
  },
];
export default function Badges() {
  return (
    <>
      ...
      />
      <PageBreadcrumb pageTitle="الاسئلة الشائعة" />
